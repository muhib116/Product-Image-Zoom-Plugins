        ...
        scaleUpDownMegnifier(megnifier)
        {
            ...
            parent.addEventListener('wheel', (e)=>
            {
                ...
                }else
                {
                    ...
                    {
                        if((myThis.megnifierSize.width + myThis.zoom)<parent.offsetWidth)
                        {
                            myThis.megnifierSize.width += myThis.zoom;
                        }else{
                            myThis.megnifierSize.width = parent.offsetWidth;
                        }

                        if((myThis.megnifierSize.height + myThis.zoom)<parent.offsetHeight)
                        {
                            myThis.megnifierSize.height += myThis.zoom;
                        }else{
                            myThis.megnifierSize.height = parent.offsetHeight;
                        }
                    }
                }
...
/* new Image_zoom({
    img: '.zoomThisImage',
    bgColor: '#bb330011',
    borderColor: '#bb330055',
    megnifierSize: 100, 
    zoom: 10,
    outputSize: 450,
    megnifierLoweLimit: 40
}); */